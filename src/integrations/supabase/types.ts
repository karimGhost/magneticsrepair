...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      profiles: {
        Row: {
          ...
          id: string
          phone: string | null
          tech_status: Database["public"]["Enums"]["tech_status"] | null
          updated_at: string
        }
        Insert: {
          address?: string | null
      ...
      repair_updates: {
        ...
        Relationships: [
          {
            foreignKeyName: "repair_updates_ticket_id_fkey"
            columns: ["ticket_id"]
            isOneToOne: false
            referencedRelation: "repair_tickets"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      gen_tracking_id: { Args: never; Returns: string }
      has_role: {
        Args: {
    ...
    Enums: {
      ...
      payment_method: "mpesa" | "cash" | "card" | "bank"
      ...
      repair_status:
        ...
        | "ready_pickup"
        | "collected"
      tech_status: "pending" | "approved" | "rejected"
    }
    CompositeTypes: {
      [_ in never]: never
    }
