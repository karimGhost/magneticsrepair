...
import { $ as readResponseWithSizeLimit, A as getToolCaller, At as object$1, Bt as InvalidResponseDataError, C as dynamicTool, Ct as custom, D as generateId, Dt as looseObject, E as filterNullable, Et as literal, F as isExecutableTool, Ft as AISDKError, G as loadOptionalSetting, Gt as NoSuchModelError, H as jsonSchema, Ht as LoadAPIKeyError, I as isFullMediaType, It as APICallError, J as normalizeHeaders, Jt as TypeValidationError, Kt as NoSuchProviderReferenceError, L as isNonNullable, Lt as EmptyResponseBodyError, M as isAbortError, Mt as string, N as isBuffer, Nt as union, O as getFromApi, Ot as never, Pt as unknown, Q as postJsonToApi, Qt as isJSONObject, R as isProviderReference, Rt as InvalidArgumentError$1, S as detectMediaType, St as boolean, T as fetchWithValidatedRedirects, Tt as lazy, U as lazySchema, Ut as LoadSettingError, V as isUrlSupported, Vt as JSONParseError, Wt as NoContentGeneratedError, Xt as getErrorMessage, Y as parseJsonEventStream, Yt as UnsupportedFunctionalityError, Z as parseTranscriptionStreamPart, Zt as isJSONArray, _ as createJsonErrorResponseHandler, _t as _enum, a as TRANSCRIPTION_STREAM_START_FRAME_TYPE, at as safeValidateTypes, b as createProviderExecutedToolFactory, bt as any, c as cancelResponseBody, ct as tool, d as convertBase64ToUint8Array, dt as waitForWebSocketBufferDrain, et as resolve, ft as withUserAgentSuffix, g as createIdGenerator, gt as WORKFLOW_SERIALIZE, h as createEventSourceResponseHandler, ht as WORKFLOW_DESERIALIZE, i as TRANSCRIPTION_STREAM_AUDIO_DONE_FRAME_TYPE, it as safeParseJSON, jt as record, k as getRuntimeEnvironmentUserAgent, kt as number, l as combineHeaders, lt as toolCaller, m as convertUint8ArrayToBase64, mt as zodSchema, n as DelayedPromise, o as asArray, ot as secureJsonParse, pt as withoutTrailingSlash, qt as TooManyEmbeddingValuesForCallError, r as DownloadError, rt as retryWithExponentialBackoff, s as asSchema, st as serializeModelOptions, t as DEFAULT_MAX_DOWNLOAD_SIZE, u as connectToWebSocket, ut as validateTypes, v as createJsonResponseHandler, vt as _instanceof, w as executeTool, wt as discriminatedUnion, x as delay, xt as array$1, yt as _null, zt as InvalidPromptError } from "./dist-CY6Ysgsk.js";
...
function createUIMessageStream({ execute, onError = () => "An error occurred.", originalMessages, onStepEnd, onStepFinish, onEnd, onFinish, generateId: generateId2 = generateId }) {
	let controller;
...
function streamObject(options) {
	const { model, output = "object", instructions, system, prompt, messages, allowSystemInMessages, maxRetries, abortSignal, headers, experimental_repairText, repairText = experimental_repairText, experimental_telemetry, telemetry = experimental_telemetry, experimental_download: download2, providerOptions, onStart, experimental_onStart, onStepStart, experimental_onStepStart, onStepEnd, onStepFinish, onError = ({ error }) => {
		console.error(error);
	}, onFinish, _internal: { generateId: generateId2 = originalGenerateId5, currentDate = () => /* @__PURE__ */ new Date(), now: now2 = now } = {}, ...settings } = options;
...
var BrowserRealtimeTransport = class {
	...
	sendRaw(data) {
		var _a23;
		if (((_a23 = this.ws) == null ? void 0 : _a23.readyState) === WebSocket.OPEN) if (typeof data === "string" || data instanceof ArrayBuffer || ArrayBuffer.isView(data) || data instanceof Blob) this.ws.send(data);
...
function isLikelyText(data) {
	...
	const BASE64_CHECK_LENGTH = Math.ceil(516 / 3) * 4;
