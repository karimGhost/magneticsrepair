import { At as object, B as isSameOrigin, D as generateId, Dt as looseObject, Et as literal, Ft as AISDKError, I as isFullMediaType, K as mapReasoningToProviderBudget, M as isAbortError, Mt as string, Nt as union, O as getFromApi, P as isCustomReasoning, Pt as unknown, Q as postJsonToApi, Rt as InvalidArgumentError, St as boolean, U as lazySchema, W as loadApiKey, X as parseProviderOptions, Yt as UnsupportedFunctionalityError, _ as createJsonErrorResponseHandler, _t as _enum, b as createProviderExecutedToolFactory, d as convertBase64ToUint8Array, dt as waitForWebSocketBufferDrain, et as resolve, f as convertInlineFileDataToUint8Array, ft as withUserAgentSuffix, gt as WORKFLOW_SERIALIZE, h as createEventSourceResponseHandler, ht as WORKFLOW_DESERIALIZE, it as safeParseJSON, j as getTopLevelMediaType, jt as record, k as getRuntimeEnvironmentUserAgent, kt as number, l as combineHeaders, m as convertUint8ArrayToBase64, mt as zodSchema, nt as resolveProviderReference, ot as secureJsonParse, p as convertToBase64, pt as withoutTrailingSlash, q as mapReasoningToProviderEffort, qt as TooManyEmbeddingValuesForCallError, st as serializeModelOptions, tt as resolveFullMediaType, u as connectToWebSocket, v as createJsonResponseHandler, x as delay, xt as array, y as createNullLanguageModelUsage, z as isRecord } from "./dist-CY6Ysgsk.js";
...
var googleTranslationModelOptions = lazySchema(() => zodSchema(object({ 
/**
...
function createGoogleLiveTranslationStream({ webSocket, url, headers, setup, inputAudioRate, finishGraceMs, warnings, audio, abortSignal, includeRawChunks }) {
	let finished = false;
	let cleanup = () => {};
	return new ReadableStream({
		start: (controller) => {
...
function buildGoogleLiveTranslationSetup({ modelId, targetLanguage, providerOptions }) {
	return {
...
//#endregion
export { GoogleRealtimeModel as Experimental_GoogleRealtimeModel, GoogleTranslationModel as Experimental_GoogleTranslationModel, VERSION, createGoogle, createGoogle as createGoogleGenerativeAI, google };
