import { t as getServerFnById } from "./__23tanstack-start-server-fn-resolver-DCNahUei.js";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-CuOXChRP.js");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CgSTuNcU.js"),
		import("./start-C-OlEXSk.js"),
