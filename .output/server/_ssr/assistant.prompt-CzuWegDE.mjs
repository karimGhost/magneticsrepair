import { At as objectType, Et as arrayType, Ot as enumType, jt as stringType } from "../_libs/@ai-sdk/gateway+[...].mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/assistant.prompt-CzuWegDE.js
var AssistantInput = objectType({ messages: arrayType(objectType({
	role: enumType(["user", "assistant"]),
	content: stringType().min(1).max(4e3)
})).min(1).max(30) });
var ASSISTANT_SYSTEM = `You are "Magnet", the AI assistant for Magnetic Repair, a premium device repair workshop.
...
//#endregion
export { AssistantInput as n, ASSISTANT_SYSTEM as t };
